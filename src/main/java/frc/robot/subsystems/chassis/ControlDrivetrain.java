...
public class ControlDrivetrain extends DrivetrainBase {
  ...
  private SlewRateLimiter x = new SlewRateLimiter(1.8);
  private SlewRateLimiter z = new SlewRateLimiter(1.8);
  ...
  public void arcadeDrive(double xSpeed, double zRotation){
    ...
    xSpeed = x.calculate(xSpeed);
    xSpeed = applyDeadband(xSpeed, m_deadband);

    zRotation = MathUtil.clamp(zRotation, -1.0, 1.0);
    zRotation = z.calculate(zRotation);
    ...
    leftMas.set(ControlMode.PercentOutput, MathUtil.clamp(-leftMotorOutput, -1.0, 1.0));
    rightMas.set(ControlMode.PercentOutput, MathUtil.clamp(-rightMotorOutput, -1.0, 1.0));
  }
